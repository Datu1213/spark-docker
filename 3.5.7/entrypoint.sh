...
# Add Ivy jars to classpath to avoid issues with dependency resolution 
# in thrift server and spark-submit when using dbt-spark or other packages.
SPARK_CLASSPATH="$SPARK_CALSSPATH:${SPARK_IVY_DIR}/jars/*"
